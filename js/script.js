...
button.addEventListener("click", () => {
  fetch(
    ...
    .then((data) => {
      ...
      temperature.textContent = temperatureDisplay + "℃";
...
fetch(urlPart1 + "houston" + "&units=metric" + "&appid=" + ACCESS_KEY)
  ...
  .then((data) => {
    ...
    /**/
    feels1.textContent = "Feels like: " + feelsLike1 + "℃";
    temperature1.textContent = temperatureDisplay1 + "℃";
...
fetch(urlPart1 + "alabama" + "&units=metric" + "&appid=" + ACCESS_KEY)
  ...
  .then((data) => {
    ...
    /**/
    feels2.textContent = "Feels like: " + feelsLike2 + "℃";
    temperature2.textContent = temperatureDisplay2 + "℃";
...
fetch(urlPart1 + "california" + "&units=metric" + "&appid=" + ACCESS_KEY)
  ...
  .then((data) => {
    ...
    /**/
    feels3.textContent = "Feels like: " + feelsLike3 + "℃";
    temperature3.textContent = temperatureDisplay3 + "℃";
...
fetch(urlPart1 + "washington" + "&units=metric" + "&appid=" + ACCESS_KEY)
  ...
  .then((data) => {
    ...
    /**/
    feels4.textContent = "Feels like: " + feelsLike4 + "℃";
    temperature4.textContent = temperatureDisplay4 + "℃";
